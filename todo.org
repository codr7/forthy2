* add restack macro/op
** interpret rest as result
** eval scopes with value pushed & replace with result
** bench & commit fib_tail
* convert fib_rec/iter to use restack
* replace drop/copy/swap with restack
* --
* add recall macro
** only client methods
** optional target
